...
export const FilterBar = (props: FilterBar) => {
  const {isShowFilterBar, className} = props;
	return (
		<nav
			id="sidenav-2"
			className={cn(" w-60 -translate-x-full overflow-hidden hidden bg-white duration-100  mt-3", isShowFilterBar && "translate-x-0 block", className)}
		>
